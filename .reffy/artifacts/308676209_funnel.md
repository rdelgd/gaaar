...
- The funnels should measure dropoff for new or returning users who complete step_1 (Viewed VDP) start sessions on the new and used VDP pages, page path dimension for the new and used VDP pages are "/express/" or "/express/used" respectively, then complete a step_2 (lead event). 
